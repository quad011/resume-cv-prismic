...
<template>
  <div
    :class="[
      ...
      'transition-all duration-500 fixed w-full left-0 top-0 z-50 lg:mix-blend-difference',
    ]"
  >
    <header
      :class="{
      ...
      class="app-header bg-white lg:bg-transparent px-4 lg:px-16 py-4 lg:py-10 fixed top-0 left-0 w-full flex items-start justify-between text-white mix-blend-difference z-[100] pointer-events-none transition-all duration-500"
    >
      <!-- LOGO -->
      <nuxt-link
        to="/"
      ...
      >
        <img
          alt="logo"
          class="logo w-[12vw] sm:w-[10vw] lg:w-[5vw] object-contain transition-all duration-500 invert lg:invert-0"
