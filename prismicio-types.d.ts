...
export interface MoreProjectsSliceDefaultPrimaryItemsItem {
  ...
  /**
   * Image field in *MoreProjects → Default → Primary → Items*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: more_projects.default.primary.items[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;
}
...
export interface ProjectsSliceDefaultPrimaryItemsItem {
  ...
  /**
   * Video Poster field in *Projects → Default → Primary → Items*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: projects.default.primary.items[].video_poster
   * - **Documentation**: https://prismic.io/docs/field#image
   */
